...
namespace Difi.Felles.Utility.Tests
{
    ...
    public class XmlValidatorTests
    {
        ...
        {
            const string ugyldigPersonnummer = "311084469111";
            ...
            const string forventetWarning = "The 'http://kontaktinfo.difi.no/xsd/oppslagstjeneste/16-02:personidentifikator' element is invalid - The value '311084469111' is invalid according to its datatype 'http://begrep.difi.no:personidentifikator' - The actual length is not equal to the specified length.\n";
